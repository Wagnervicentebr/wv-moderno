...
**VOCÊ NÃO DEVE** Gerar um arquivo de resumo do que foi implementado, use o chat para isso sem criar arquivo para resumir o que foi feito
...
<critical>Utilize o Figma MCP sempre que tiver um layout no figma e sigma exatamente como o layout especifica</critical>

<critical>Após completar a tarefa, marque como completa em cada task</critical>
